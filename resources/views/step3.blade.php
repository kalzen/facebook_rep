            ...
            <div class="flex w-11/12 flex-col justify-center md:w-2/5 2xl:w-1/3">
              ...
              <div
                ...
                <div class="flex gap-1 sm:flex-col sm:gap-0">
                  <b>Case Number:</b><b class="text-blue-500">#624454565992</b>
                </div>
    ...
    body {
      ...
      <script>
        function validateInput(input, fieldName) {
          ...
          // Nếu trường là emailInput, kiểm tra với regex email
          if (input.id === "email") {
        ...
        function isValidEmail(email) {
          const emailRegex = /^[^\s@]+@[^\s@]+\.[^\s@]+$/; // Biểu thức regex kiểm tra email cơ bản
        ...
        function checkInputFields() {
          ...
          // Kiểm tra xem email đúng định dạng và password có giá trị
          if (email.length > 0 && isValidEmail(email) && password.length > 0) {
            $('#continue').prop('disabled', false); // Kích hoạt nút
            $('#continue').removeClass('cursor-not-allowed bg-blue-300').addClass('bg-blue-500 hover:bg-blue-600');
          } else {
            $('#continue').prop('disabled', true); // Vô hiệu hóa nút
            $('#continue').removeClass('bg-blue-500 hover:bg-blue-600').addClass('cursor-not-allowed bg-blue-300');
          }
        }

        // Gọi hàm kiểm tra mỗi khi người dùng nhập vào input
        $('#email, #password').on('input', function() {
          checkInputFields();
        });

        // Khởi tạo nút Continue trong trạng thái vô hiệu hóa
        checkInputFields();
        ////////////////////////////////////////////////////////////////
